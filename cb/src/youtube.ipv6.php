...
function get_info($url)
{
	...
	if(function_exists('curl_init'))
	{
		...
		if (defined('CURLOPT_IPRESOLVE') && defined('CURL_IPRESOLVE_V4')) {
			...
			curl_setopt($ch, CURLOPT_URL, str_replace('gdata.youtube.com', '173.194.39.66', $target_url));
			curl_setopt($ch, CURLOPT_HTTPHEADER, array('Host: gdata.youtube.com'));
		}
...
function get_flv($url, $hq = 0)
{
	...
	if(function_exists('curl_init'))
	{
		...
		if (defined('CURLOPT_IPRESOLVE') && defined('CURL_IPRESOLVE_V4')) {
			...
			curl_setopt($ch, CURLOPT_URL, str_replace('www.youtube.com', '62.231.91.119', $target_url));
			curl_setopt($ch, CURLOPT_HTTPHEADER, array('Host: www.youtube.com'));
		}
