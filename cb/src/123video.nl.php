...
function get_info($url)
{
	...
	preg_match('/MovieID=([0-9]+)/', $url, $matches);
	
	$target_url = 'http://www.123video.nl/playvideos.asp?MovieID='. $matches[1];
...
{
	$title = $thumb = $tags = $description = false;
	...
	$info['direct'] = 'http://www.123video.nl/playvideos.asp?MovieID='. $id;
	$info['url_flv'] = 'http://www.123video.nl/123video_emb.swf?mediaSrc='. $id;
	$info['yt_id'] = $id;
}
