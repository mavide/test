<?php /* Smarty version 2.6.18, created on 2013-04-10 18:50:56
         compiled from C:%5CProgram+Files+%28x86%29%5CEasyPHP-12.1%5Cwww%5Ccb/styles/youtube/layout/blocks/rating.html */ ?>
...
')" class="newLike">Like</div>
    <div style="width:102px; float:left; height:14px; margin-top:15px">
...
<div id="rating_result_container" style="margin-top:4px; color: #333333;
    font-size: 10px;
    font-weight: bold;" align="center"><?php if ($this->_tpl_vars['rating_msg']): ?><?php echo $this->_tpl_vars['rating_msg']; ?>
