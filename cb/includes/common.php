...
if(!@$in_bg_cron)
{
	...
	require_once('classes/artists.class.php');
...
//DIRECT URL OF VIDEO FILES
 ...
 //Required Settings For Video Conversion
	...
	define('ARTIST_THUMBS_DIR',BASEDIR.'/images/artist_thumbs');

	define('ARTIST_THUMBS_URL',BASEURL.'/images/artist_thumbs');
...
$Smarty->assign_by_ref('cbartist',$cbartist);
...
$Smarty->register_function('show_artist_form_cl','show_artist_form_cl');
$Smarty->register_function('show_artist_form_v','show_artist_form_v');
...
$Smarty->register_function('get_artists','get_artists');
// MDF V00.2
$Smarty->register_function('get_public_active_collections','get_public_active_collections');
$Smarty->register_function('get_public_active_artists','get_public_active_artists');
// FIN MDF V00.2
...
$Smarty->register_modifier('get_artist_name','get_artist_name');
