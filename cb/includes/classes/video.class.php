...
class CBvideo extends CBCategory
{
	...
	function init_artists()

	{

		$this->artist = new Artists();

		$this->artist->objType = "v";

		$this->artist->objClass = "cbvideo";

		$this->artist->objTable = "collections";

		$this->artist->objName = "Video";

		$this->artist->objFunction = "video_exists";

		$this->artist->objFieldID = "collection_id";	
